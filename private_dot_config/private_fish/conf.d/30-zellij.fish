...
if status is-interactive; and test "$TERM" = xterm-ghostty; and not set -q ZELLIJ; and not set -q CONDUCTOR_WORKSPACE_NAME; and not set -q SKIP_MUX; and not set -q SSH_CONNECTION; and not set -q SSH_TTY
